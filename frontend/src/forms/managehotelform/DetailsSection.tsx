...
const DetailsSection = () => {
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <label className='text-gray-700 text-sm font-bold '>Price Per Night
                ...
                {errors.pricePerNight && (<span className='text-red-500'>
            ...
            <label className='text-gray-700 text-sm font-bold max-w-[50%]'>Star Rating
                ...
                {errors.starRating && (<span className='text-red-500'>
