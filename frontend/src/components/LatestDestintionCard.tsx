...
const LatestDestintionCard = ({ hotel }: Props) => {
    return (
        <Link to={`/detail/${hotel._id}`} className="relative cursor-pointer overflow-hidden rounded-md">
            ...
            <div className="absolute buttom-0 p-4 bg-black bg-opacity-50 w-full rounded-b-md">
...
export default LatestDestintionCard;
